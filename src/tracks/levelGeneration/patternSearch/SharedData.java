...
public class SharedData {
	 ...
	 */
	public static final double MAX_COVER_PERCENTAGE = 1;
	/**
	 ...
	 */
	public static final boolean CONSTRUCTIVE_INITIALIZATION = true;	// EDIT? ---------------------------------
	...
	/**
	 * pattern level generator to help in speeding up the level generation process
	 */
	public static tracks.levelGeneration.patternConstructive.LevelGenerator patternGen; // EDIT ----------------------------------------------
